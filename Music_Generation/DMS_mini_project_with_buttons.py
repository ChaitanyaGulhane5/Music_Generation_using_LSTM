...
class MelodyGen:
    def __init__(
        self, model_path=r"C:\Users\Chaitanya\PycharmProjects\project_final\project_final\model.h5"
    ):
        self.model_path = model_path
        self.model = keras.models.load_model(model_path)

        with open(
            r"C:\Users\Chaitanya\PycharmProjects\project_final\project_final\data\mapping.json", "r"
        ) as fp:
    ...
    def save_melody(self, melody, mood):
        ...
        stream.write(
            "midi",
            fp=r"C:\Users\Chaitanya\PycharmProjects\project_final\project_final\generated_music\happy.mid",
        )
...
#    emo = input("Enter emotion(h for happy, s for sad, a for angry): ")
    ...
    fp = r"C:\Users\Chaitanya\PycharmProjects\project_final\project_final\generated_music\{lund}-{emo}.mid"
...
def main():
    ...
    img = PhotoImage(file = r'C:\Users\Chaitanya\PycharmProjects\project_final\project_final\boombox.png',master=root)
